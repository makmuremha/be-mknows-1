...
export class FileController {
  ...
  public getFileById = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
  ...
  public userFiles = asyncHandler(async (req: RequestWithUser, res: Response, next: NextFunction) => {
    const user_id = req.user.pk as number;
